...
class Settings(BaseSettings):
    ...
    mcp_strict_mode: bool = Field(False, alias="MCP_STRICT_MODE")
    ...
    mcp_rancher_kubeconfig_paths: str = Field("", alias="MCP_RANCHER_KUBECONFIG_PATHS")
    mcp_rancher_endpoints: str = Field("", alias="MCP_RANCHER_ENDPOINTS")
    mcp_rancher_api_url_sandbox: str = Field("", alias="MCP_RANCHER_API_URL_SANDBOX")
    mcp_rancher_api_token_sandbox: str = Field("", alias="MCP_RANCHER_API_TOKEN_SANDBOX")
    mcp_rancher_api_url_eks: str = Field("", alias="MCP_RANCHER_API_URL_EKS")
    mcp_rancher_api_token_eks: str = Field("", alias="MCP_RANCHER_API_TOKEN_EKS")
    mcp_rancher_api_url: str = Field("", alias="MCP_RANCHER_API_URL")
    mcp_rancher_api_token: str = Field("", alias="MCP_RANCHER_API_TOKEN")
    mcp_rancher_region: str = Field("on-prem", alias="MCP_RANCHER_REGION")
